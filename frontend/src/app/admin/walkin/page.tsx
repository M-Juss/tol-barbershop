...
export default function Walkin() {
  return (
    <div className="w-full bg-slate-100 p-4 sm:p-6 font-sans min-h-screen">
      ...
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Walk-ins</h1>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-4">
        ...
        <div className="flex justify-stretch sm:justify-end mt-6">
          <Button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-5 gap-2">
