...
export default function Overview() {
  ...
  return (
    <div className="w-full h-full bg-slate-100 p-4 sm:p-6 font-sans min-h-screen">

      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Manager Overview</h1>
