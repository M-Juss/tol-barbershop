  ...
  return (
    <main className="flex-1">
      ...
      <div className="mx-auto grid w-full max-w-5xl gap-8 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-[14rem_minmax(0,1fr)] lg:gap-12 lg:px-8">
        <aside className="order-2 h-fit rounded-xl border border-border bg-card p-5 shadow-sm lg:sticky lg:top-6 lg:order-1">
        ...
        <article className="order-1 min-w-0 rounded-xl border border-border bg-card px-5 py-2 shadow-sm sm:px-8 lg:order-2 [&_a]:font-medium [&_a]:text-primary [&_a]:underline [&_a]:decoration-accent/50 [&_a]:underline-offset-4 hover:[&_a]:text-accent [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_li]:pl-1 [&_p]:leading-7 [&_section]:border-b [&_section]:border-border [&_section]:py-7 [&_section:last-child]:border-b-0 [&_strong]:font-semibold [&_ul]:ml-5 [&_ul]:list-disc [&_ul]:space-y-2">
          {children}
        </article>
      </div>
    </main>
